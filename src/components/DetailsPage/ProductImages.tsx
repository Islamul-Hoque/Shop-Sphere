        ...
        <div className="flex float-start">
            <div>
                {images?.map((item, index) => (
                    <Image key={index} src={item} alt="productImage" width={200} height={200}
            ...
            <div className="bg-gray-100 rounded-md ml-5 w-full max-h-[550px]">
                <Image src={currentImage} className="w-full h-full object-contain" alt="productImage" width={500} height={500} />
            </div>
        </div>
    );
};
