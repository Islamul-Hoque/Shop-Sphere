    ...
    return (
        <div className='flex py-6 sm:py-10'>
            ...
            <Link href={{
                ...
                query: { id: product?.id },
            }} className="h-24 w-24 sm:h-48 sm:w-48 border border-primary/30 hover:border-primary overflow-hidden flex items-center justify-center rounded-md"  >
                <Image src={product?.images[0]} width={300} height={300} className="h-full w-full p-2 rounded-md object-contain bg-[#f7f7f7] hover:scale-110 duration-200" alt="productImage" />
            </Link>
            {/* Details */}
                ...
                <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                    ...
                    <div className="mt-4 sm:mt-0 sm:pr-9">
                        <div className="absolute right-0 top-0">
                            <button onClick={handleRemoveProduct} className="p-2 text-gray-800 bg-gray-50 hover:bg-gray-100 hover:text-red-700" > <IoClose /> </button>
                        </div>
                    </div>
                </div>
                <div>
