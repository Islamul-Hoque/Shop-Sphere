        ...
        <>
            {
                existingProduct ? <div className="flex self-start items-center justify-center gap-2 py-2 mb-2">
                    <button onClick={() => {
                        ...
                        className=" bg-[#f7f7f7] text-black p-2 border-[1px] border-gray-200 hover:border-primary rounded-full text-sm hover:bg-white duration-200 cursor-pointer disabled:text-gray-300 disabled:hover:bg-[#f7f7f7]">  <FaMinus />  </button>
                    ...
                    <button onClick={() => {
                        ...
                        className=" bg-[#f7f7f7] text-black p-2 border-[1px] border-gray-200 hover:border-primary rounded-full text-sm hover:bg-white duration-200 cursor-pointer disabled:text-gray-300 disabled:hover:bg-[#f7f7f7]">    <FaPlus />   </button>
                </div>
